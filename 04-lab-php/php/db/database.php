...
class DatabaseHelper{
    ...
    public function getPostById($id){
        $query = "SELECT idarticolo, titoloarticolo, imgarticolo, dataarticolo, testoarticolo, nome FROM articolo, autore WHERE autore=idautore AND idarticolo=? ORDER BY dataarticolo DESC";
        $stmt = $this->db->prepare($query);
